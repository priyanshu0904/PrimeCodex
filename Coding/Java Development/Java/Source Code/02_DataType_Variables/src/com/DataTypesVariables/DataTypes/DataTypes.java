package com.DataTypesVariables.DataTypes;
...
public class DataTypes {
    public static void main(String[] args){
        ...
        float myFloat = 5.0f; //f indicates the float, can be F
        ...
        //double literal
        double myDouble = 5.9; //by default double without f, and can use d/D also
